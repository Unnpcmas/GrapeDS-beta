...
Grape DS is a lightweight Android fork of [melonDS](https://melonds.kuribo64.net/).
It keeps the original melonDS GPLv3 license and credits; changes made by this fork
are marked in the source and documentation. Grape DS uses its own application ID,
so it can be installed alongside the original melonDS Android app.
